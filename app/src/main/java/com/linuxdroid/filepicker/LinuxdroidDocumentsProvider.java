 ...
 */
public class LinuxdroidDocumentsProvider extends DocumentsProvider {

    private static final String ALL_MIME_TYPES = "*/*";

    private static final File BASE_DIR = new File(LinuxdroidService.HOME_PATH);
    ...
    public Cursor querySearchDocuments(String rootId, String query, String[] projection) throws FileNotFoundException {
        ...
        while (!pending.isEmpty() && result.getCount() < MAX_SEARCH_RESULTS) {
            ...
            try {
                isInsideHome = file.getCanonicalPath().startsWith(LinuxdroidService.HOME_PATH);
            } catch (IOException e) {
                isInsideHome = true;
            }
