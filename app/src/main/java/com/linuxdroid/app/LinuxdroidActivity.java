...
import com.linuxdroid.terminal.TerminalColors;
import com.linuxdroid.terminal.TerminalSession;
import com.linuxdroid.terminal.TerminalSession.SessionChangedCallback;
import com.linuxdroid.terminal.TextStyle;
 ...
 * about memory leaks.
 */
public final class LinuxdroidActivity extends Activity implements ServiceConnection {
    ...
    private static final String RELOAD_STYLE_ACTION = "com.linuxdroid.app.reload_style";
    ...
    LinuxdroidPreferences mSettings;

    /**
     * The connection to the {@link LinuxdroidService}. Requested in {@link #onCreate(Bundle)} with a call to
     * {@link #bindService(Intent, ServiceConnection, int)}, and obtained and stored in
     * {@link #onServiceConnected(ComponentName, IBinder)}.
     */
    LinuxdroidService mTermService;
            ...
            if (mIsVisible) {
                ...
                if ("storage".equals(whatToReload)) {
                    if (ensureStoragePermissionGranted())
                        LinuxdroidInstaller.setupStorageSymlinks(LinuxdroidActivity.this);
                    return;
                }
                checkForFontAndColors();
                mSettings.reloadFromProperties(LinuxdroidActivity.this);
            }
        }
    };
    ...
    void checkForFontAndColors() {
        try {
            ...
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.linuxdroid/files/home/.linuxdroid/colors.properties");
    ...
    public void onCreate(Bundle bundle) {
        ...
        mSettings = new LinuxdroidPreferences(this);

        setContentView(R.layout.drawer_layout);
        mTerminalView = findViewById(R.id.terminal_view);
        mTerminalView.setOnKeyListener(new LinuxdroidViewClient(this));
        ...
        viewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(@NonNull ViewGroup collection, int position) {
                LayoutInflater inflater = LayoutInflater.from(LinuxdroidActivity.this);
                View layout;
                if (position == 0) {
        ...
        newSessionButton.setOnLongClickListener(v -> {
            DialogUtils.textInput(LinuxdroidActivity.this, R.string.session_new_named_title, null, R.string.session_new_named_positive_button,
        ...
        Intent serviceIntent = new Intent(this, LinuxdroidService.class);
    ...
    void toggleShowExtraKeys() {
        final ViewPager viewPager = findViewById(R.id.viewpager);
        final boolean showNow = mSettings.toggleShowExtraKeys(LinuxdroidActivity.this);
    ...
    public void onServiceConnected(ComponentName componentName, IBinder service) {
        mTermService = ((LinuxdroidService.LocalBinder) service).service;
        ...
        mTermService.mSessionChangeCallback = new SessionChangedCallback() {
            ...
            public void onBell(TerminalSession session) {
                ...
                switch (mSettings.mBellBehaviour) {
                    case LinuxdroidPreferences.BELL_BEEP:
                        mBellSoundPool.play(mBellSoundId, 1.f, 1.f, 1, 0, 1.f);
                        break;
                    case LinuxdroidPreferences.BELL_VIBRATE:
                        ((Vibrator) getSystemService(VIBRATOR_SERVICE)).vibrate(50);
                        break;
                    case LinuxdroidPreferences.BELL_IGNORE:
        ...
        if (mTermService.getSessions().isEmpty()) {
            if (mIsVisible) {
                LinuxdroidInstaller.setupIfNeeded(LinuxdroidActivity.this, () -> {
    ...
    public void onServiceDisconnected(ComponentName name) {
        // Respect being stopped from the LinuxdroidService notification action.
        finish();
    }
    ...
    protected void onStop() {
        ...
        mIsVisible = false;
        TerminalSession currentSession = getCurrentTermSession();
        if (currentSession != null) LinuxdroidPreferences.storeCurrentSession(this, currentSession);
    ...
    void showUrlSelection() {
        ...
        final AlertDialog dialog = new AlertDialog.Builder(LinuxdroidActivity.this).setItems(urls, (di, which) -> {
            String url = (String) urls[which];
            ClipboardManager clipboard = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
            clipboard.setPrimaryClip(new ClipData(null, new String[]{"text/plain"}, new ClipData.Item(url)));
            Toast.makeText(LinuxdroidActivity.this, R.string.select_url_copied_to_clipboard, Toast.LENGTH_LONG).show();
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("com.linuxdroid.styling", "com.linuxdroid.styling.LinuxdroidStyleActivity");
                try {
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, (dialog, which) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.linuxdroid.styling")))).setNegativeButton(android.R.string.cancel, null).show();
                }
                return true;
            }
            case CONTEXTMENU_HELP_ID:
                startActivity(new Intent(this, LinuxdroidHelpActivity.class));
                return true;
            default:
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        if (requestCode == REQUESTCODE_PERMISSION_STORAGE && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            LinuxdroidInstaller.setupStorageSymlinks(this);
        }
    }
    ...
    public TerminalSession getStoredCurrentSessionOrLast() {
        TerminalSession stored = LinuxdroidPreferences.getCurrentSession(this);
    ...
    void showToast(String text, boolean longDuration) {
        ...
        mLastToast = Toast.makeText(LinuxdroidActivity.this, text, longDuration ? Toast.LENGTH_LONG : Toast.LENGTH_SHORT);
    ...
    public void removeFinishedSession(TerminalSession finishedSession) {
        ...
        LinuxdroidService service = mTermService;
