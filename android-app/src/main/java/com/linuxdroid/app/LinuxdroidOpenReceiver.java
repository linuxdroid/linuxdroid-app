...
public class LinuxdroidOpenReceiver extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {
        final Uri data = intent.getData();
        if (data == null) {
            Log.e(EmulatorDebug.LOG_TAG, "linuxdroid-open: Called without intent data");
            return;
        }
        ...
        if (isExternalUrl) {
            ...
            try {
                ...
                Log.e(EmulatorDebug.LOG_TAG, "linuxdroid-open: No app handles the url " + data);
            }
            return;
        }
        ...
        if (!(fileToShare.isFile() && fileToShare.canRead())) {
            Log.e(EmulatorDebug.LOG_TAG, "linuxdroid-open: Not a readable file: '" + fileToShare.getAbsolutePath() + "'");
            return;
        }
        ...
        Uri uriToShare = Uri.withAppendedPath(Uri.parse("content://com.linuxdroid.files/"), filePath);
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(LinuxdroidService.FILES_PATH) || path.startsWith(storagePath))) {
